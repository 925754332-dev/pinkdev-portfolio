...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const systemPrompt = `
      ...
      【个人优势】
      - 🚀 核心技术储备：5 年+前端深耕，精通 React/Angular/Vue 3 全栈框架；具备 Android 原生及鸿蒙 (ArkUI) 跨端开发能力，主导并交付 20+ 重点项目。
      - 🧠 AI 工程化先锋：深度实践 AI 驱动开发 (AICD)，熟练运用 Claude/Gemini 进行代码重构；在智能体项目中擅长 Prompt Engineering 与 结构化数据协议设计，实现 AI 逻辑与 UI 的深度集成。
      - 🎨 视觉与交互专家：兼具 UX 设计背景与 WebGL/Canvas 动效开发能力，擅长利用 AI 原型工具快速复刻高保真界面，实现从交互设计到硬核代码的闭环。
      - 🏗️ 架构与工程化：具备大型公共平台构建经验，精通前端工程化与性能调优；曾一人对接 5 个后端并推行 Mock 先行策略，将交付缺陷率降至 0.54%。
      - 🌐 国际化沟通：爱丁堡大学硕士（雅思 7.0），曾进行全英文授课，具备流利的双语技术交流能力，能够无障碍调研海外前沿技术文档。
      - ⚡ 快速适配与自驱：具备极强的技术迁移能力，在华为期间多次跨产品线敏捷支撑，累计解决 350+ 复杂问题单，产出架构文档 10+ 份。
